---
title: MySQL数据库知识
date: 2019-10-24 23:36:02
categories: 
    MySQL
tags:
    MySQL-Notes
cover: http://r.photo.store.qq.com/psb?/V13Zm3q236IRIM/7UZQoG0HCWQjmk9*87E65njxpm*saQlFrM5*SGa2ruA!/r/dFMBAAAAAAAA
...
![img](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/9Vn45kV3Bqtzxl3X3gmBCajvIJkLHKAPwKOOyjpp9s4!/r/dLYAAAAAAAAA)
...
![img](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/rHNYnY*xtvxtLG*4mrYpBivKymK94.o96HOg8WgcalE!/r/dAYBAAAAAAAA)
...
![1550467448201](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/Y6BJgG7bt4nN*W3nCUOoRfGBhz1CwVk7H.ryzEM8heI!/r/dFQBAAAAAAAA)
...
​    ![img](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/HWy6XOUl520SMZ0.mV4TNv2AtRffq7VYxQvrQp6YJo0!/r/dLYAAAAAAAAA)
...
![1550468251532](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/7k5ljIjZ4L3U9SSp9q7Fkrc*GMFJaJnOvTj.R9WtgBM!/r/dLYAAAAAAAAA)

**辅助索引的叶子节点的 data 域记录着主键的值，因此在使用辅助索引进行查找时，需要先查找到主键值，然后再到主索引中进行查找。**

![1550468294210](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/ZA9O8HUnjnFNrOeej12rLXbcz9OCdCmCGR.rWbxuIQg!/r/dD4BAAAAAAAA)
...
![](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/jiOX2Ib.OVaVGH6a6.BHzFPBHq5sDxeSx7x7CpOvHN0!/r/dFIBAAAAAAAA)
...
![](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/t0L1z1S*49WFoq58n018y6OSbuFkoM9JGCJlKSVBRwA!/r/dLgAAAAAAAAA)

这里设表一共有三列，假设我们以Col1为主键，则上图是一个MyISAM表的主索引（Primary key）示意。可以看出MyISAM的索引文件仅仅保存数据记录的地址。在MyISAM中，主索引和辅助索引（Secondary key）在结构上没有任何区别，只是主索引要求key是唯一的，而辅助索引的key可以重复。如果我们在Col2上建立一个辅助索引，则此索引的结构如下图所示：

![](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/63*LAll3tJtezEHWGWVbYs9.xxkCrXpO4BEKyFbBO0U!/r/dLYAAAAAAAAA)
...
![](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/bs6eM5lhylPOdUXLzMTDy.o7WDmK7BK3ZMPIpP92OjU!/r/dFMBAAAAAAAA)

上图是InnoDB主索引（同时也是数据文件）的示意图，可以看到叶节点包含了完整的数据记录。这种索引叫做聚集索引。因为InnoDB的数据文件本身要按主键聚集，**所以InnoDB要求表必须有主键（MyISAM可以没有）**，如果没有显式指定，则MySQL系统会自动选择一个可以唯一标识数据记录的列作为主键，如果不存在这种列，则MySQL自动为InnoDB表生成一个隐含字段作为主键，这个字段长度为6个字节，类型为长整形。

第二个与MyISAM索引的不同是InnoDB的辅助索引data域存储相应记录主键的值而不是地址。换句话说，InnoDB的所有辅助索引都引用主键作为data域。例如，下图为定义在Col3上的一个辅助索引：

![](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/25lhpy9Ll*oArcqBS*32JOuanlf5TxuJK*CEsA8D55E!/r/dL8AAAAAAAAA)
...
![1550728150375](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/uEhI0NVKqeE1SVYEmnE7cz3wUXKWgyGyBybqReAdorU!/r/dE0BAAAAAAAA)
...
![1550728228269](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/eWI19hRBf3ddfiS*y.NpVP4mSXTARn6G5Pj9M1QcZT4!/r/dL8AAAAAAAAA)

![1550728239905](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/Qdn18NWJRQ6.q**Z2ccrVFwT6hvX0.OA09LZibIzAb8!/r/dDcBAAAAAAAA)

使用`show status like 'slow_queries'`显示慢查询的次数

![1550728646391](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/iD5wQHPkATNEAjSwNGrFNnYCusDg*XIQTf0DX3egZPU!/r/dLgAAAAAAAAA)

查看日志：

![1550728619714](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/PpYLL6QSSOEIECKXDuTRLmpDbkRAJU6F*2TQBU2GBX4!/r/dDcBAAAAAAAA)
...
![1550729396796](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/R8zLIY2cUQ7ZaQSLEIzwIcmuBqZzcTXgXUvfqSpGwiM!/r/dFABAAAAAAAA)

在empno字段上建立主键索引：`ALTER TABLE emp ADD PRIMARY KEY(empno);`

![1550729590333](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/DJpe9hWFLhHYflOpafu9XRlk8pdSCH1wAl5k89CpOPU!/r/dL4AAAAAAAAA)

再次查询：

![1550729615581](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/j2yoiAuqzD2zyXYP0CeWOvlLlpNIHl9Rch19kLPYiCw!/r/dL8AAAAAAAAA)
...
![1550730034562](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/xxURSLjlX*IeoUfwUzPI.fvSspoYpv8JikBJIrgTScI!/r/dLYAAAAAAAAA)
...
![](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/8HPvhyu*UYWHav8ey2HgoC1ZeUHwUYQ8YUml07a5DhE!/r/dMMAAAAAAAAA)
...
![](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/fwF8Bhs9lABsVYCOMH8SXEo8uD63zrlgvPbejG*KA1E!/r/dIMAAAAAAAAA)
...
![](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/tw4VoJsIK8Q7a6Jy4*4CH7kJQh8jbntbYZX1m2A3aBA!/r/dL8AAAAAAAAA)

## 14.3 字符串类型

字符串类型指CHAR、VARCHAR、BINARY、VARBINARY、BLOB、TEXT、ENUM和SET。该节描述了这些类型如何工作以及如何在查询中使用这些类型。

![](http://r.photo.store.qq.com/psb?/V13Zm3q20AQyWf/aZjlkiWDb0x7g8H5XDu.5ruQbZdlcyIqlmmgmOB.k0Q!/r/dD4BAAAAAAAA)
